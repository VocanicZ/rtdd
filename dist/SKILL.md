---
name: rtdd
description: Surface which tests cover the code you changed, and which changed lines nothing covers, from recorded coverage rather than a static graph. Use when editing a Python repository that has a .rtdd/map.jsonl, before or after changing source files, to find the relevant tests and the untested part of a diff.
---
